...
Before proceeding to the econometric test approach it is important to inspect the data graphically and at the same time take a look at the summary of statistics of the series. 
This as well aims to underline the coherence of the aggreagtion procedure and it helps to gain a first insight into the behaviour of the unemployment rate and the google trends indicators over the last years. Figure
\ref{fig:timeseriesw12} displays the monthly unemployment rate together with the biweekly Google search indices for the W12 window.
The sample that covers from June 2011 till January 2023, composses different important economic succession such as the Covid 19 crisi or as well the large period of the eurozone discovery. 
Here the normalization of the google trends actually allows us comparability within the specific keywords but not across keywords.
By the first glimpse we mwe could assume that the search engine terms reveal a slight co-movement with unemployment. 
The public sector related searches such as Arbeitsamt and jobbörse, clearly exhibit a downward trend, similar to the decline in unemployment up to 2019, followed, by a temporary increase due ot the panedemic period. 
The private job-board searches such as Indeed and Stepstone actaully showcase more volatile dynamics, especially indeed displaying an upward moving trend, which by this time also could underline the growing relevance of online platfroms in Germanys labor market rater then a cyclical signas. This long run increase, therefore, captures sturctural change in the job search behaviour, while shorter term fluctuations such as especially represented in the stepstoen time series still convey cyclical information relevant for later nowcasting
The keyword bewerbung disaplys relative stable but moderate seasonal factors are clearly visible. Whereas this peaks could coincide with perods of labor-market tension rather than with downturns, which indicas that it might react more to job-search actuvty among the employed and clearly to seasonal apploication patterns.
The seasonal unadjusted unemployment itself follows a slow moving trend with short-term, cyclical and seasonal patters, reaching its pre pandemic low in 2019 and then sharply increasing in 2020 and only gradually recovering thereafter.
The developments are well captured within the sample window and provide enough variablility for the later following error correction analysis.
When now taking a look at Figure \ref{fig:timeseriesw34} we see the time series plotted for the variables that capture the search habits in the last two weeks of the prior month and hence right before the publishing of the unemployment rate by the federal employment agency. The Stepstone variable for instance here shows high variability especially with seasonal downward peaks with a slight downward drift after 2016. 
The spikes seem to be kind of seasonal patterns but it looks consistent with job seekers reacting to worsening labor market expectations.
It behaves very similar to the later stepstone time series only that the later one is smoother and includes less extreme spikes.
Indeed here show a clear upward trend, which again udnerlines the adoption of indeed in germany. Especially here it is good to see how local peaks appear during the start of the pandemic. 
Both overall show this kind of continues upward structural climb, whereas the series in W34prev shows some small more spikes. 
The jobbörse and as well the arbeitsamt variable both show a strong decline over time yet temporary rises around downturns (2013, 2020) examplify anticipatory behaviour of those approaching official portals before worsening conditions. They could both be seen as classical inflow proxies. The movements in W12 and W34 are quite similar with the difference that earlier ones showacase more spikes. 
 The Bewerbung variable similarly displays recurring seasonal patterns but remains broadly stable over time, consistent with continuous application-related search behavior rather than cyclical responses.
Complementing the visual inspection, it is notable that private job-board searches such as Indeed or Stepstone exhibit considerably higher standard deviations than the public-sector or application-related terms. This heterogeneity likely reflects differences in user bases, search motivations, and the underlying structural trends of the respective platforms.\\
Table~\ref{tab:descshort} also reports mean and standard deviations for the mentioned variables.
It perfectly matches the visual interpretation underlying how search activity on private platforms, especially Indeed, is by far the most volatile (std.= 40), and hence the most responsive to short term chnages in labor market conditins. 
Public sector searches such as Jobbörse or Arbeitsamt show smaller average values but entail still a considerable variation. (std. = 16-24). 
In contrats Stepstone and Bewerbing display lower volatility (std. = 13-14) which is consistent with the smoother trends and seasonal  cycles observed in the Figures~\ref{fig:timeseriesw34} and~\ref{fig:timeseriesw12}. 
The unemployment rate itself is, as expected, far less variable (std.= 0.72). 
Overall, the variability patterns confirm that private job-board searches are more dynamic and likely to reflect real-time labor-market sentiment, whereas public-portal and application-related terms respond more intermittently.
\\
Moreover as for the interest whether the search indicators and the unemployment itself contains any predictive information about future labor-market conditions we conducted a correlation analysis between each variable and the unemploymnet one month ahead. 
Here results showcases how searches related to the public sector prortals such as Jobbörse (0.73) and Arbeitsamt (0.72) are positively correlated with susbsequent uneployment, indicating an icrease in these terms tend to precede rising joblessness. Stepstone and Bewerbung show moderate positive correlations (around 0.45–0.59), suggesting some anticipatory component, though their reactions appear less pronounced. 
Interetsing here Indeed exhibits a tsring negative correlations across both widows consistent with its structural upward trend and countercyclical nature as a proxy for hiring activity rather than job loss. 
The correlation analysis yields a first glimpse into the heterogenity of the indicators, while public and administrative search terms behave procyclically, private job board searches partly reflect long term digitalization effects.
